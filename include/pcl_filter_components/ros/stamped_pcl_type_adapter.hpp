...
#ifndef PCL_FILTER_COMPONENTS__ROS__STAMPED_PCL_TYPE_ADAPTER_HPP_
#define PCL_FILTER_COMPONENTS__ROS__STAMPED_PCL_TYPE_ADAPTER_HPP_
...
#endif  // PCL_FILTER_COMPONENTS__ROS__STAMPED_PCL_TYPE_ADAPTER_HPP_
