...
using Filter =
  pcl_filter_components::filters::segmentation::PlaneModelFilter<pcl::PointXYZ>;
using PlaneModelFilterXYZComponent =
...
RCLCPP_COMPONENTS_REGISTER_NODE(pcl_filter_components_xyz::PlaneModelFilterXYZComponent)
