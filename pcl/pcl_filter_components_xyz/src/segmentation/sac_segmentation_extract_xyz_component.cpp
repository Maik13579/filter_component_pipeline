...
using Filter =
  pcl_filter_components::filters::segmentation::SACSegmentationExtractFilter<pcl::PointXYZ>;
using SACSegmentationExtractXYZComponent =
...
RCLCPP_COMPONENTS_REGISTER_NODE(pcl_filter_components_xyz::SACSegmentationExtractXYZComponent)
