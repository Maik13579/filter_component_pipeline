...
using Filter =
  pcl_filter_components::filters::segmentation::EuclideanClusterExtractFilter<pcl::PointXYZ>;
using EuclideanClusterExtractXYZComponent =
...
RCLCPP_COMPONENTS_REGISTER_NODE(pcl_filter_components_xyz::EuclideanClusterExtractXYZComponent)
