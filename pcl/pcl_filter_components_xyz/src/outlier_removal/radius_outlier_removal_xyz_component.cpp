...
using Filter =
  pcl_filter_components::filters::outlier_removal::RadiusOutlierRemovalFilter<pcl::PointXYZ>;
using RadiusOutlierRemovalXYZComponent =
...
RCLCPP_COMPONENTS_REGISTER_NODE(pcl_filter_components_xyz::RadiusOutlierRemovalXYZComponent)
