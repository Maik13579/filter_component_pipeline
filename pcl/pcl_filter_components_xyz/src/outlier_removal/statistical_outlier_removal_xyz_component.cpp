...
using Filter =
  pcl_filter_components::filters::outlier_removal::StatisticalOutlierRemovalFilter<pcl::PointXYZ>;
using StatisticalOutlierRemovalXYZComponent =
...
RCLCPP_COMPONENTS_REGISTER_NODE(pcl_filter_components_xyz::StatisticalOutlierRemovalXYZComponent)
