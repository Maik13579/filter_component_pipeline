...
using Filter =
  pcl_filter_components::filters::surface::MorphologicalFilter<pcl::PointXYZ>;
using MorphologicalFilterXYZComponent =
...
RCLCPP_COMPONENTS_REGISTER_NODE(pcl_filter_components_xyz::MorphologicalFilterXYZComponent)
