...
using Filter =
  pcl_filter_components::filters::surface::MovingLeastSquaresFilter<pcl::PointXYZ>;
using MovingLeastSquaresXYZComponent =
...
RCLCPP_COMPONENTS_REGISTER_NODE(pcl_filter_components_xyz::MovingLeastSquaresXYZComponent)
