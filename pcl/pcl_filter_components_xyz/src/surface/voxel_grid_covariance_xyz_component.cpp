...
using Filter =
  pcl_filter_components::filters::surface::VoxelGridCovarianceFilter<pcl::PointXYZ>;
using VoxelGridCovarianceXYZComponent =
...
RCLCPP_COMPONENTS_REGISTER_NODE(pcl_filter_components_xyz::VoxelGridCovarianceXYZComponent)
