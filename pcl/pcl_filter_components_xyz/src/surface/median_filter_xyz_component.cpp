...
using Filter =
  pcl_filter_components::filters::surface::MedianFilter<pcl::PointXYZ>;
using MedianFilterXYZComponent =
...
RCLCPP_COMPONENTS_REGISTER_NODE(pcl_filter_components_xyz::MedianFilterXYZComponent)
