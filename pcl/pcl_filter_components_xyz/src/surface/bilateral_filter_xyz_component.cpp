...
using Filter =
  pcl_filter_components::filters::surface::BilateralFilter<pcl::PointXYZ>;
using BilateralFilterXYZComponent =
...
RCLCPP_COMPONENTS_REGISTER_NODE(pcl_filter_components_xyz::BilateralFilterXYZComponent)
