...
using Filter =
  pcl_filter_components::filters::selection::KeepOrganizedFilter<pcl::PointXYZ>;
using KeepOrganizedXYZComponent =
...
RCLCPP_COMPONENTS_REGISTER_NODE(pcl_filter_components_xyz::KeepOrganizedXYZComponent)
