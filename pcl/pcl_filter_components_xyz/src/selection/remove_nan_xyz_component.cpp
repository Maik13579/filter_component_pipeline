...
using Filter =
  pcl_filter_components::filters::selection::RemoveNaNFilter<pcl::PointXYZ>;
using RemoveNaNXYZComponent =
...
RCLCPP_COMPONENTS_REGISTER_NODE(pcl_filter_components_xyz::RemoveNaNXYZComponent)
