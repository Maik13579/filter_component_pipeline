...
using Filter =
  pcl_filter_components::filters::spatial::ProjectInliersFilter<pcl::PointXYZ>;
using ProjectInliersXYZComponent =
...
RCLCPP_COMPONENTS_REGISTER_NODE(pcl_filter_components_xyz::ProjectInliersXYZComponent)
