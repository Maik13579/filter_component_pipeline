...
using Filter =
  pcl_filter_components::filters::spatial::PlaneClipperFilter<pcl::PointXYZ>;
using PlaneClipperXYZComponent =
...
RCLCPP_COMPONENTS_REGISTER_NODE(pcl_filter_components_xyz::PlaneClipperXYZComponent)
