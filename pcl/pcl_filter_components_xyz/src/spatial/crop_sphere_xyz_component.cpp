...
using Filter =
  pcl_filter_components::filters::spatial::CropSphereFilter<pcl::PointXYZ>;
using CropSphereXYZComponent =
...
RCLCPP_COMPONENTS_REGISTER_NODE(pcl_filter_components_xyz::CropSphereXYZComponent)
