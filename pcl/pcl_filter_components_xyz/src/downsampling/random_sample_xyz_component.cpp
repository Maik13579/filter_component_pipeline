...
using Filter =
  pcl_filter_components::filters::downsampling::RandomSampleFilter<pcl::PointXYZ>;
using RandomSampleXYZComponent =
...
RCLCPP_COMPONENTS_REGISTER_NODE(pcl_filter_components_xyz::RandomSampleXYZComponent)
