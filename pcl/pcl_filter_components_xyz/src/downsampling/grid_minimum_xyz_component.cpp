...
using Filter =
  pcl_filter_components::filters::downsampling::GridMinimumFilter<pcl::PointXYZ>;
using GridMinimumXYZComponent =
...
RCLCPP_COMPONENTS_REGISTER_NODE(pcl_filter_components_xyz::GridMinimumXYZComponent)
