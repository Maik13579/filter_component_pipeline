# pcl_filter_components_xyz

`pcl_filter_components_xyz` instantiates the reusable filters from
...
`cloud` and `orig_cloud` outputs; `PointCloudMergerXYZ` uses
...
```yaml
package: pcl_filter_components_xyz
component_class: pcl_filter_components_xyz::VoxelGridXYZComponent
```
