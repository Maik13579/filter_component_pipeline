...
using Filter =
  pcl_filter_components::filters::intensity::IntensityThresholdFilter<pcl::PointXYZI>;
using IntensityThresholdXYZIComponent =
...
RCLCPP_COMPONENTS_REGISTER_NODE(pcl_filter_components_xyzi::IntensityThresholdXYZIComponent)
