...
using Filter =
  pcl_filter_components::filters::intensity::IntensityRangeFilter<pcl::PointXYZI>;
using IntensityRangeFilterXYZIComponent =
...
RCLCPP_COMPONENTS_REGISTER_NODE(pcl_filter_components_xyzi::IntensityRangeFilterXYZIComponent)
