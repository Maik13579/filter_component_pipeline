...
using Filter =
  pcl_filter_components::filters::spatial::FrustumCullingFilter<pcl::PointXYZI>;
using FrustumCullingXYZIComponent =
...
RCLCPP_COMPONENTS_REGISTER_NODE(pcl_filter_components_xyzi::FrustumCullingXYZIComponent)
