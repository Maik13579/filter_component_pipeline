...
using Filter =
  pcl_filter_components::filters::spatial::PlaneClipperFilter<pcl::PointXYZI>;
using PlaneClipperXYZIComponent =
...
RCLCPP_COMPONENTS_REGISTER_NODE(pcl_filter_components_xyzi::PlaneClipperXYZIComponent)
