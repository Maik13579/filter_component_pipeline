...
using Filter =
  pcl_filter_components::filters::spatial::ProjectInliersFilter<pcl::PointXYZI>;
using ProjectInliersXYZIComponent =
...
RCLCPP_COMPONENTS_REGISTER_NODE(pcl_filter_components_xyzi::ProjectInliersXYZIComponent)
