...
using Filter =
  pcl_filter_components::filters::segmentation::PlaneModelFilter<pcl::PointXYZI>;
using PlaneModelFilterXYZIComponent =
...
RCLCPP_COMPONENTS_REGISTER_NODE(pcl_filter_components_xyzi::PlaneModelFilterXYZIComponent)
