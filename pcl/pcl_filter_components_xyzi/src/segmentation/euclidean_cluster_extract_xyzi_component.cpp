...
using Filter =
  pcl_filter_components::filters::segmentation::EuclideanClusterExtractFilter<pcl::PointXYZI>;
using EuclideanClusterExtractXYZIComponent =
...
RCLCPP_COMPONENTS_REGISTER_NODE(pcl_filter_components_xyzi::EuclideanClusterExtractXYZIComponent)
