...
using Filter =
  pcl_filter_components::filters::segmentation::SACSegmentationExtractFilter<pcl::PointXYZI>;
using SACSegmentationExtractXYZIComponent =
...
RCLCPP_COMPONENTS_REGISTER_NODE(pcl_filter_components_xyzi::SACSegmentationExtractXYZIComponent)
