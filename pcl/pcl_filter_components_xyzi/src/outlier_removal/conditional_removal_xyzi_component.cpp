...
using Filter =
  pcl_filter_components::filters::outlier_removal::ConditionalRemovalFilter<pcl::PointXYZI>;
using ConditionalRemovalXYZIComponent =
...
RCLCPP_COMPONENTS_REGISTER_NODE(pcl_filter_components_xyzi::ConditionalRemovalXYZIComponent)
