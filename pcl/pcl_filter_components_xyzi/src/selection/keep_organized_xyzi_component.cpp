...
using Filter =
  pcl_filter_components::filters::selection::KeepOrganizedFilter<pcl::PointXYZI>;
using KeepOrganizedXYZIComponent =
...
RCLCPP_COMPONENTS_REGISTER_NODE(pcl_filter_components_xyzi::KeepOrganizedXYZIComponent)
