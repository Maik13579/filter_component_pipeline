...
using Filter =
  pcl_filter_components::filters::selection::ExtractIndicesFilter<pcl::PointXYZI>;
using ExtractIndicesXYZIComponent =
...
RCLCPP_COMPONENTS_REGISTER_NODE(pcl_filter_components_xyzi::ExtractIndicesXYZIComponent)
