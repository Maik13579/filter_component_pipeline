...
using Filter =
  pcl_filter_components::filters::selection::RemoveNaNFilter<pcl::PointXYZI>;
using RemoveNaNXYZIComponent =
...
RCLCPP_COMPONENTS_REGISTER_NODE(pcl_filter_components_xyzi::RemoveNaNXYZIComponent)
