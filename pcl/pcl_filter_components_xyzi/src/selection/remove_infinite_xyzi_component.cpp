...
using Filter =
  pcl_filter_components::filters::selection::RemoveInfiniteFilter<pcl::PointXYZI>;
using RemoveInfiniteXYZIComponent =
...
RCLCPP_COMPONENTS_REGISTER_NODE(pcl_filter_components_xyzi::RemoveInfiniteXYZIComponent)
