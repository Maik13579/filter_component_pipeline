...
using Filter =
  pcl_filter_components::filters::downsampling::RandomSampleFilter<pcl::PointXYZI>;
using RandomSampleXYZIComponent =
...
RCLCPP_COMPONENTS_REGISTER_NODE(pcl_filter_components_xyzi::RandomSampleXYZIComponent)
