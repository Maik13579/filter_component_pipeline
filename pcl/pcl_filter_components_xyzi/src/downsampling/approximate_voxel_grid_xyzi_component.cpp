...
using Filter =
  pcl_filter_components::filters::downsampling::ApproximateVoxelGridFilter<pcl::PointXYZI>;
using ApproximateVoxelGridXYZIComponent =
...
RCLCPP_COMPONENTS_REGISTER_NODE(pcl_filter_components_xyzi::ApproximateVoxelGridXYZIComponent)
