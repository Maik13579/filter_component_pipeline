...
using Filter =
  pcl_filter_components::filters::downsampling::GridMinimumFilter<pcl::PointXYZI>;
using GridMinimumXYZIComponent =
...
RCLCPP_COMPONENTS_REGISTER_NODE(pcl_filter_components_xyzi::GridMinimumXYZIComponent)
