...
using Filter =
  pcl_filter_components::filters::surface::VoxelGridCovarianceFilter<pcl::PointXYZI>;
using VoxelGridCovarianceXYZIComponent =
...
RCLCPP_COMPONENTS_REGISTER_NODE(pcl_filter_components_xyzi::VoxelGridCovarianceXYZIComponent)
