...
using Filter =
  pcl_filter_components::filters::surface::BilateralFilter<pcl::PointXYZI>;
using BilateralFilterXYZIComponent =
...
RCLCPP_COMPONENTS_REGISTER_NODE(pcl_filter_components_xyzi::BilateralFilterXYZIComponent)
