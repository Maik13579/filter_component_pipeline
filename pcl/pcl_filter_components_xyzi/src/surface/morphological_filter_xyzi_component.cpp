...
using Filter =
  pcl_filter_components::filters::surface::MorphologicalFilter<pcl::PointXYZI>;
using MorphologicalFilterXYZIComponent =
...
RCLCPP_COMPONENTS_REGISTER_NODE(pcl_filter_components_xyzi::MorphologicalFilterXYZIComponent)
