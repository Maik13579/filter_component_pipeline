...
using Filter =
  pcl_filter_components::filters::selection::ExtractIndicesFilter<pcl::PointXYZRGB>;
using ExtractIndicesXYZRGBComponent =
...
RCLCPP_COMPONENTS_REGISTER_NODE(pcl_filter_components_xyzrgb::ExtractIndicesXYZRGBComponent)
