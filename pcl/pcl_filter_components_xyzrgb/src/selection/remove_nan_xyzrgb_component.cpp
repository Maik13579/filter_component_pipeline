...
using Filter =
  pcl_filter_components::filters::selection::RemoveNaNFilter<pcl::PointXYZRGB>;
using RemoveNaNXYZRGBComponent =
...
RCLCPP_COMPONENTS_REGISTER_NODE(pcl_filter_components_xyzrgb::RemoveNaNXYZRGBComponent)
