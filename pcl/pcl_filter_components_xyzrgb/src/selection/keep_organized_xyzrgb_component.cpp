...
using Filter =
  pcl_filter_components::filters::selection::KeepOrganizedFilter<pcl::PointXYZRGB>;
using KeepOrganizedXYZRGBComponent =
...
RCLCPP_COMPONENTS_REGISTER_NODE(pcl_filter_components_xyzrgb::KeepOrganizedXYZRGBComponent)
