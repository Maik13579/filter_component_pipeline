...
using Filter =
  pcl_filter_components::filters::outlier_removal::RadiusOutlierRemovalFilter<pcl::PointXYZRGB>;
using RadiusOutlierRemovalXYZRGBComponent =
...
RCLCPP_COMPONENTS_REGISTER_NODE(pcl_filter_components_xyzrgb::RadiusOutlierRemovalXYZRGBComponent)
