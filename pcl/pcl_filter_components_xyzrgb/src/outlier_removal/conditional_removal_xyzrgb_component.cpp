...
using Filter =
  pcl_filter_components::filters::outlier_removal::ConditionalRemovalFilter<pcl::PointXYZRGB>;
using ConditionalRemovalXYZRGBComponent =
...
RCLCPP_COMPONENTS_REGISTER_NODE(pcl_filter_components_xyzrgb::ConditionalRemovalXYZRGBComponent)
