...
using Filter =
  pcl_filter_components::filters::outlier_removal::StatisticalOutlierRemovalFilter<pcl::PointXYZRGB>;
using StatisticalOutlierRemovalXYZRGBComponent =
...
RCLCPP_COMPONENTS_REGISTER_NODE(pcl_filter_components_xyzrgb::StatisticalOutlierRemovalXYZRGBComponent)
