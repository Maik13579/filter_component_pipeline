...
using Filter =
  pcl_filter_components::filters::spatial::CropSphereFilter<pcl::PointXYZRGB>;
using CropSphereXYZRGBComponent =
...
RCLCPP_COMPONENTS_REGISTER_NODE(pcl_filter_components_xyzrgb::CropSphereXYZRGBComponent)
