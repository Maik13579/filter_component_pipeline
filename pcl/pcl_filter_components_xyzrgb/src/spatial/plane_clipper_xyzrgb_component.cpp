...
using Filter =
  pcl_filter_components::filters::spatial::PlaneClipperFilter<pcl::PointXYZRGB>;
using PlaneClipperXYZRGBComponent =
...
RCLCPP_COMPONENTS_REGISTER_NODE(pcl_filter_components_xyzrgb::PlaneClipperXYZRGBComponent)
