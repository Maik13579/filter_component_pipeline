...
using Filter =
  pcl_filter_components::filters::multi_input::PointCloudSubtractFilter<pcl::PointXYZRGB>;
using PointCloudSubtractXYZRGBComponent =
...
RCLCPP_COMPONENTS_REGISTER_NODE(pcl_filter_components_xyzrgb::PointCloudSubtractXYZRGBComponent)
