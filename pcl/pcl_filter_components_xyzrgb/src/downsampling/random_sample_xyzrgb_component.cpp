...
using Filter =
  pcl_filter_components::filters::downsampling::RandomSampleFilter<pcl::PointXYZRGB>;
using RandomSampleXYZRGBComponent =
...
RCLCPP_COMPONENTS_REGISTER_NODE(pcl_filter_components_xyzrgb::RandomSampleXYZRGBComponent)
