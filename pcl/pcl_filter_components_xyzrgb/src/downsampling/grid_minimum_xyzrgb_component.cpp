...
using Filter =
  pcl_filter_components::filters::downsampling::GridMinimumFilter<pcl::PointXYZRGB>;
using GridMinimumXYZRGBComponent =
...
RCLCPP_COMPONENTS_REGISTER_NODE(pcl_filter_components_xyzrgb::GridMinimumXYZRGBComponent)
