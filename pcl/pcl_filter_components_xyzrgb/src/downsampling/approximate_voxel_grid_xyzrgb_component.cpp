...
using Filter =
  pcl_filter_components::filters::downsampling::ApproximateVoxelGridFilter<pcl::PointXYZRGB>;
using ApproximateVoxelGridXYZRGBComponent =
...
RCLCPP_COMPONENTS_REGISTER_NODE(pcl_filter_components_xyzrgb::ApproximateVoxelGridXYZRGBComponent)
