...
using Filter =
  pcl_filter_components::filters::color::ColorThresholdFilter<pcl::PointXYZRGB>;
using ColorThresholdXYZRGBComponent =
...
RCLCPP_COMPONENTS_REGISTER_NODE(pcl_filter_components_xyzrgb::ColorThresholdXYZRGBComponent)
