...
using Filter =
  pcl_filter_components::filters::surface::MedianFilter<pcl::PointXYZRGB>;
using MedianFilterXYZRGBComponent =
...
RCLCPP_COMPONENTS_REGISTER_NODE(pcl_filter_components_xyzrgb::MedianFilterXYZRGBComponent)
