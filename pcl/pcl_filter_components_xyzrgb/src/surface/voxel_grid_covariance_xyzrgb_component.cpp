...
using Filter =
  pcl_filter_components::filters::surface::VoxelGridCovarianceFilter<pcl::PointXYZRGB>;
using VoxelGridCovarianceXYZRGBComponent =
...
RCLCPP_COMPONENTS_REGISTER_NODE(pcl_filter_components_xyzrgb::VoxelGridCovarianceXYZRGBComponent)
