...
using Filter =
  pcl_filter_components::filters::surface::MorphologicalFilter<pcl::PointXYZRGB>;
using MorphologicalFilterXYZRGBComponent =
...
RCLCPP_COMPONENTS_REGISTER_NODE(pcl_filter_components_xyzrgb::MorphologicalFilterXYZRGBComponent)
