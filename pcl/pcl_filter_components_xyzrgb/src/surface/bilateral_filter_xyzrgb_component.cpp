...
using Filter =
  pcl_filter_components::filters::surface::BilateralFilter<pcl::PointXYZRGB>;
using BilateralFilterXYZRGBComponent =
...
RCLCPP_COMPONENTS_REGISTER_NODE(pcl_filter_components_xyzrgb::BilateralFilterXYZRGBComponent)
