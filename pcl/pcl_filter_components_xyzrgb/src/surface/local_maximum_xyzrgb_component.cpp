...
using Filter =
  pcl_filter_components::filters::surface::LocalMaximumFilter<pcl::PointXYZRGB>;
using LocalMaximumXYZRGBComponent =
...
RCLCPP_COMPONENTS_REGISTER_NODE(pcl_filter_components_xyzrgb::LocalMaximumXYZRGBComponent)
