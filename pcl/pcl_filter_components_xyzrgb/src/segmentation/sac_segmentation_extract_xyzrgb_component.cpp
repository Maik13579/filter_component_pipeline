...
using Filter =
  pcl_filter_components::filters::segmentation::SACSegmentationExtractFilter<pcl::PointXYZRGB>;
using SACSegmentationExtractXYZRGBComponent =
...
RCLCPP_COMPONENTS_REGISTER_NODE(pcl_filter_components_xyzrgb::SACSegmentationExtractXYZRGBComponent)
