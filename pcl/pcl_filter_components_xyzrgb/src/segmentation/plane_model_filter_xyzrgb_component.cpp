...
using Filter =
  pcl_filter_components::filters::segmentation::PlaneModelFilter<pcl::PointXYZRGB>;
using PlaneModelFilterXYZRGBComponent =
...
RCLCPP_COMPONENTS_REGISTER_NODE(pcl_filter_components_xyzrgb::PlaneModelFilterXYZRGBComponent)
