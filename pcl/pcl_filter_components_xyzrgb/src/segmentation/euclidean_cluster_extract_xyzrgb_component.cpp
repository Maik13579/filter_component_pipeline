...
using Filter =
  pcl_filter_components::filters::segmentation::EuclideanClusterExtractFilter<pcl::PointXYZRGB>;
using EuclideanClusterExtractXYZRGBComponent =
...
RCLCPP_COMPONENTS_REGISTER_NODE(pcl_filter_components_xyzrgb::EuclideanClusterExtractXYZRGBComponent)
