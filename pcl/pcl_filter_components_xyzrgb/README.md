# pcl_filter_components_xyzrgb

`pcl_filter_components_xyzrgb` instantiates the reusable filters from
...
`cloud` and `orig_cloud` outputs; `PointCloudMergerXYZRGB` uses
...
```yaml
package: pcl_filter_components_xyzrgb
component_class: pcl_filter_components_xyzrgb::VoxelGridXYZRGBComponent
```
