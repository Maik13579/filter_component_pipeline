...
{
  pcl_filter_components::filters::spatial::CropSphereFilter<pcl_filter_components_tests::Point> filter;
  ...
  EXPECT_EQ(indices, (pcl_filter_components_tests::Indices{0, 1}));
}
