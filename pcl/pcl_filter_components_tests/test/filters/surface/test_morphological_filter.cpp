...
{
  pcl_filter_components::filters::surface::MorphologicalFilter<pcl_filter_components_tests::Point> filter;
  ...
  EXPECT_LE(output.size(), pcl_filter_components_tests::organizedCloud().size());
}
