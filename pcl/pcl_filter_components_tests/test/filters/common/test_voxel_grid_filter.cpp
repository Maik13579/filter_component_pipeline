...
{
  pcl_filter_components::filters::VoxelGridFilter<pcl_filter_components_tests::Point> filter;
  ...
  EXPECT_LT(output.size(), pcl_filter_components_tests::sampleCloud().size());
