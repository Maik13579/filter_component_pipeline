...
{
  pcl_filter_components::filters::downsampling::UniformSamplingFilter<pcl_filter_components_tests::Point> filter;
  ...
  EXPECT_LT(indices.size(), pcl_filter_components_tests::sampleCloud().size());
}
