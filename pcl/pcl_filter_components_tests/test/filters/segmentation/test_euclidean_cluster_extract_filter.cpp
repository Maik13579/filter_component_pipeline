...
TEST(EuclideanClusterExtractFilterXYZI, FindsLargestCluster)
{
  ...
  cloud.push_back(pcl_filter_components_tests::point(5.01F, 5.0F, 5.0F));
  pcl_filter_components_tests::finalizeCloud(cloud);

  pcl_filter_components::filters::segmentation::EuclideanClusterExtractFilter<pcl_filter_components_tests::Point> filter;
