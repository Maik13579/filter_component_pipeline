...
using Filter =
  pcl_filter_components::filters::segmentation::EuclideanClusterExtractFilter<pcl::PointXYZRGBA>;
using EuclideanClusterExtractXYZRGBAComponent =
...
RCLCPP_COMPONENTS_REGISTER_NODE(pcl_filter_components_xyzrgba::EuclideanClusterExtractXYZRGBAComponent)
