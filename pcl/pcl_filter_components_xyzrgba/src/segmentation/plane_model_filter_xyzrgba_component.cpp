...
using Filter =
  pcl_filter_components::filters::segmentation::PlaneModelFilter<pcl::PointXYZRGBA>;
using PlaneModelFilterXYZRGBAComponent =
...
RCLCPP_COMPONENTS_REGISTER_NODE(pcl_filter_components_xyzrgba::PlaneModelFilterXYZRGBAComponent)
