...
using Filter =
  pcl_filter_components::filters::selection::RemoveInfiniteFilter<pcl::PointXYZRGBA>;
using RemoveInfiniteXYZRGBAComponent =
...
RCLCPP_COMPONENTS_REGISTER_NODE(pcl_filter_components_xyzrgba::RemoveInfiniteXYZRGBAComponent)
