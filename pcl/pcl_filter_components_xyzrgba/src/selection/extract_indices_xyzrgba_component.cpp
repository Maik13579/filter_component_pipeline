...
using Filter =
  pcl_filter_components::filters::selection::ExtractIndicesFilter<pcl::PointXYZRGBA>;
using ExtractIndicesXYZRGBAComponent =
...
RCLCPP_COMPONENTS_REGISTER_NODE(pcl_filter_components_xyzrgba::ExtractIndicesXYZRGBAComponent)
