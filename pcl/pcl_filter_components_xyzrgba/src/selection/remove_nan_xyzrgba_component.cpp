...
using Filter =
  pcl_filter_components::filters::selection::RemoveNaNFilter<pcl::PointXYZRGBA>;
using RemoveNaNXYZRGBAComponent =
...
RCLCPP_COMPONENTS_REGISTER_NODE(pcl_filter_components_xyzrgba::RemoveNaNXYZRGBAComponent)
