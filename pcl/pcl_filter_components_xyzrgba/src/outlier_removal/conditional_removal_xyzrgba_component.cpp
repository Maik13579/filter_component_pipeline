...
using Filter =
  pcl_filter_components::filters::outlier_removal::ConditionalRemovalFilter<pcl::PointXYZRGBA>;
using ConditionalRemovalXYZRGBAComponent =
...
RCLCPP_COMPONENTS_REGISTER_NODE(pcl_filter_components_xyzrgba::ConditionalRemovalXYZRGBAComponent)
