...
using Filter =
  pcl_filter_components::filters::outlier_removal::StatisticalOutlierRemovalFilter<pcl::PointXYZRGBA>;
using StatisticalOutlierRemovalXYZRGBAComponent =
...
RCLCPP_COMPONENTS_REGISTER_NODE(pcl_filter_components_xyzrgba::StatisticalOutlierRemovalXYZRGBAComponent)
