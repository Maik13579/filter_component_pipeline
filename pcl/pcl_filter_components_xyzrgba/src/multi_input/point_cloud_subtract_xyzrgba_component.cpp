...
using Filter =
  pcl_filter_components::filters::multi_input::PointCloudSubtractFilter<pcl::PointXYZRGBA>;
using PointCloudSubtractXYZRGBAComponent =
...
RCLCPP_COMPONENTS_REGISTER_NODE(pcl_filter_components_xyzrgba::PointCloudSubtractXYZRGBAComponent)
