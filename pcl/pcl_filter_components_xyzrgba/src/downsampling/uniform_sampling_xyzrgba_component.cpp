...
using Filter =
  pcl_filter_components::filters::downsampling::UniformSamplingFilter<pcl::PointXYZRGBA>;
using UniformSamplingXYZRGBAComponent =
...
RCLCPP_COMPONENTS_REGISTER_NODE(pcl_filter_components_xyzrgba::UniformSamplingXYZRGBAComponent)
