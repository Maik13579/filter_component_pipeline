...
using Filter =
  pcl_filter_components::filters::downsampling::ApproximateVoxelGridFilter<pcl::PointXYZRGBA>;
using ApproximateVoxelGridXYZRGBAComponent =
...
RCLCPP_COMPONENTS_REGISTER_NODE(pcl_filter_components_xyzrgba::ApproximateVoxelGridXYZRGBAComponent)
