...
using Filter =
  pcl_filter_components::filters::color::ColorThresholdFilter<pcl::PointXYZRGBA>;
using ColorThresholdXYZRGBAComponent =
...
RCLCPP_COMPONENTS_REGISTER_NODE(pcl_filter_components_xyzrgba::ColorThresholdXYZRGBAComponent)
