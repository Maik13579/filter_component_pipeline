...
using Filter =
  pcl_filter_components::filters::spatial::PlaneClipperFilter<pcl::PointXYZRGBA>;
using PlaneClipperXYZRGBAComponent =
...
RCLCPP_COMPONENTS_REGISTER_NODE(pcl_filter_components_xyzrgba::PlaneClipperXYZRGBAComponent)
