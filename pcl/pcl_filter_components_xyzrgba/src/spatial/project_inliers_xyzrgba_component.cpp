...
using Filter =
  pcl_filter_components::filters::spatial::ProjectInliersFilter<pcl::PointXYZRGBA>;
using ProjectInliersXYZRGBAComponent =
...
RCLCPP_COMPONENTS_REGISTER_NODE(pcl_filter_components_xyzrgba::ProjectInliersXYZRGBAComponent)
