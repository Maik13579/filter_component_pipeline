...
using Filter =
  pcl_filter_components::filters::spatial::FrustumCullingFilter<pcl::PointXYZRGBA>;
using FrustumCullingXYZRGBAComponent =
...
RCLCPP_COMPONENTS_REGISTER_NODE(pcl_filter_components_xyzrgba::FrustumCullingXYZRGBAComponent)
