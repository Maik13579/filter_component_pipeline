...
using Filter =
  pcl_filter_components::filters::surface::MedianFilter<pcl::PointXYZRGBA>;
using MedianFilterXYZRGBAComponent =
...
RCLCPP_COMPONENTS_REGISTER_NODE(pcl_filter_components_xyzrgba::MedianFilterXYZRGBAComponent)
