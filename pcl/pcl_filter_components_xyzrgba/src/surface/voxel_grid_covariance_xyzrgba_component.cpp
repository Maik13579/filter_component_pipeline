...
using Filter =
  pcl_filter_components::filters::surface::VoxelGridCovarianceFilter<pcl::PointXYZRGBA>;
using VoxelGridCovarianceXYZRGBAComponent =
...
RCLCPP_COMPONENTS_REGISTER_NODE(pcl_filter_components_xyzrgba::VoxelGridCovarianceXYZRGBAComponent)
