...
using Filter =
  pcl_filter_components::filters::surface::MorphologicalFilter<pcl::PointXYZRGBA>;
using MorphologicalFilterXYZRGBAComponent =
...
RCLCPP_COMPONENTS_REGISTER_NODE(pcl_filter_components_xyzrgba::MorphologicalFilterXYZRGBAComponent)
