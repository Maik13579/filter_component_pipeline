...
int main(int argc, char ** argv)
{
  ...
  auto node = std::make_shared<filter_component_factory::pipeline::PipelineFactoryNode>(
    executor,
    rclcpp::NodeOptions{}
  ...
  if (callback_return != filter_component_factory::pipeline::PipelineFactoryNode::CallbackReturn::SUCCESS) {
