...
{
  pcl_filter_components::filters::outlier_removal::ConditionalRemovalFilter<pcl_filter_tests::Point> filter;
  ...
  EXPECT_EQ(indices, (pcl_filter_tests::Indices{0, 1, 2, 3}));
}
